...
{
    public class ItemColorService : GenericService<BitItcItemsColor, BitStoreDbContext>,   IitemColor
    {
        public ItemColorService(BitStoreDbContext bitStoreDbContext, ILogger<ItemColorService> logger) : base(bitStoreDbContext, logger)
        {
        }
    }
}
