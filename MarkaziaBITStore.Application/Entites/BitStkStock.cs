...
public partial class BitStkStock
{
    public int BitStkId { get; set; }

    public int? BitStkBitItcid { get; set; }

    public int? BitStkQuantityIn { get; set; }

    public int? BitStkQuantityOut { get; set; }

    public int? BitStkReservedQuantity { get; set; }

    public int? BitStkAvailableQuantity { get; set; }
    ...
    public virtual BitItcItemsColor? BitStkBitItc { get; set; }
}
