...
public partial class BIT_STK_StockTransactions
{
    public int BIT_STK_ID { get; set; }

    public int BIT_STK__BIT_ITCID { get; set; }

    public int? BIT_STK_TransactionType { get; set; }

    public int? BIT_STK_TransactionNo { get; set; }

    public int BIT_STK_ItemQuantity { get; set; }
    ...
    public virtual BIT_ITC_ItemsColor BIT_STK__BIT_ITC { get; set; } = null!;
}
